...
from opmuse.utils import error_handler_tool, multi_headers_tool, get_staticdir
...
def main():
    ...
    if args.daemon:
        ...
        DropPrivileges(cherrypy.engine, uid=args.user, gid=args.group, umask=0o027).subscribe()
